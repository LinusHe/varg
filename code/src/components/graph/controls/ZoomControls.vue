<template>
  ...
  <v-card class="pr-2 pl-2 pt-2 pb-2">
    <v-row>
      <v-tooltip right>
        <template v-slot:activator="{ on }">
          <v-btn v-on="on" class="ma-2" @click="ZoomPlus" id="zoom-plus" text icon color="lightgrey">
    ...
    <v-row>
      <v-tooltip right>
        <template v-slot:activator="{ on }">
          <v-btn v-on="on" class="ma-2" @click="ZoomOut" id="zoom-view-all" text icon color="lightgrey">
