  ...
  <div class="header-graph-container" id="graph-header">
    <v-row>
      ...
      <v-col align="center">
        ...
        <v-btn outlined tile color="#ececec" class="bo-r-0" id="database-btn" @click="datenbank()">
          <v-icon class="mr-1">mdi-database</v-icon>Datenbank
        </v-btn>
        <v-btn outlined tile color="#ececec" class="bo-r-0" @click="LoadJSon" id="ImportGraph">
          <input type="file" ref="file" accept=".json" style="display: none" />
          <v-icon class="mr-1">mdi-import</v-icon>Import
        </v-btn>
        <v-btn outlined tile color="#ececec" class="bo-r-0" @click="Download" id="download-btn">
