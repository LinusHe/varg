  ...
  <v-dialog v-model="dialog" max-width="750">
    <v-card class="settings-dialog">
      <v-toolbar flat color="primary" dark>
        <v-toolbar-title align="center">Einstellungen</v-toolbar-title>
      </v-toolbar>
      <v-tabs vertical>
        <v-tab>
      ...
      <v-card-text class="mt-6" align="right">
        <v-btn color="success" class="mr-2">Speichern</v-btn>
        <v-btn color="error">Abbrechen</v-btn>
      </v-card-text>
    </v-card>
  </v-dialog>
</template>
