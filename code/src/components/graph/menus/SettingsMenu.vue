<template>
  <v-dialog v-model="dialog" max-width="750">
    <v-card class="settings-dialog">
      ...
      <v-tabs centered>
        <v-tab>
          <v-icon class="rot-270" left>mdi-graph</v-icon>
          Graph
        </v-tab>
        <v-tab>
            ...
            <v-card-text class="scrolling-container pb-10">
              ...
              <v-card class="ml-6 mr-6">
                <v-row>
                  ...
                  <v-col sm="2">
                    <v-switch v-model="edgeShowShortOnly" hide-details class="mt-3"></v-switch>
                  </v-col>
                </v-row>
                <v-divider></v-divider>
                <v-row>
                  <v-col sm="10">
                    <v-card-text>Kosten / Stück in Verknüpfungen anzeigen</v-card-text>
                  </v-col>
                  <v-col sm="2">
                    <v-switch v-model="edgeShowCost" :disabled="edgeShowShortOnly" class="mt-3"></v-switch>
                  </v-col>
                </v-row>
                <v-divider></v-divider>
                <v-row>
                  <v-col sm="10">
                    <v-card-text>Zeit / Stück in Verknüpfungen anzeigen</v-card-text>
                  </v-col>
                  <v-col sm="2">
                    <v-switch v-model="edgeShowTime" :disabled="edgeShowShortOnly" class="mt-3"></v-switch>
                  </v-col>
                </v-row>
                <v-divider></v-divider>
                <v-row>
                  <v-col sm="10">
                    <v-card-text>Rüstkosten in Verknüpfungen anzeigen</v-card-text>
                  </v-col>
                  <v-col sm="2">
                    <v-switch v-model="edgeShowSuCost" :disabled="edgeShowShortOnly" class="mt-3"></v-switch>
                  </v-col>
                </v-row>
                <v-divider></v-divider>
                <v-row>
                  <v-col sm="10">
                    <v-card-text>Rüstzeit in Verknüpfungen anzeigen</v-card-text>
                  </v-col>
                  <v-col sm="2">
                    <v-switch v-model="edgeShowSuTime" :disabled="edgeShowShortOnly" class="mt-3"></v-switch>
                  </v-col>
                </v-row>
                <v-divider></v-divider>
                <v-row>
                  <v-col sm="9">
                    <v-card-text>Titel der Verknüpfungen:</v-card-text>
                  </v-col>
                  <v-col sm="3">
                    <v-select
                      class="pr-8"
        ...
        <v-tab-item>
          <v-card flat class="scrolling-container">
            <v-card-text>
              <p>Morbi nec metus. Suspendisse faucibus, nunc et pellentesque egestas, lacus ante convallis tellus, vitae
                ...
                leo. Nunc sed turpis.</p>

              <p>Suspendisse feugiat. Suspendisse faucibus, nunc et pellentesque egestas, lacus ante convallis tellus,
                ...
                amet ligula pharetra condimentum.</p>

              <p>Sed consequat, leo eget bibendum sodales, augue velit cursus nunc, quis gravida magna mi a libero. Nam
                commodo suscipit quam. In consectetuer turpis ut velit. Sed cursus turpis vitae tortor. Aliquam eu
                nunc.</p>

              <p>Etiam ut purus mattis mauris sodales aliquam. Ut varius tincidunt libero. Aenean viverra rhoncus pede.
                Duis leo. Fusce fermentum odio nec arcu.</p>
        ...
        <v-tab-item>
          <v-card flat class="scrolling-container">
            <v-card-text>
              <p>Fusce a quam. Phasellus nec sem in justo pellentesque facilisis. Nam eget dui. Proin viverra, ligula
                sit amet ultrices semper, ligula arcu tristique sapien, a accumsan nisi mauris ac eros. In dui magna,
                posuere eget, vestibulum et, tempor auctor, justo.</p>
