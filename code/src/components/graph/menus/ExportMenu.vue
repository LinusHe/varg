<template>
  <v-dialog v-model="dialog" max-width="500">
    <v-card class="export-dialog">
      ...
      <v-tabs centered>
        <v-tab>
          <v-icon class="rot-270" left>mdi-desktop</v-icon>Lokal
        </v-tab>
        <v-tab>
  ...
  methods: {
    ...
    openHelpDialog() {
      dialogComponent.dialogInfo(
        "Wähle das Format <b>.json</b> oder<b>.xml</b> aus, um den Graphen in einem Format herunterzuladen, welches du später wieder im Editor importieren kannst. <br /> <br /> Wähle<b>.png</b> oder<b>.svg</b> aus, um den Graphen in einem Bildvormat herunterzuladen.", 15000
      );
    },
    switchbtntext() {
