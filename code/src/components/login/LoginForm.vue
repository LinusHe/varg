  ...
  <div>
    <v-list-item three-line class="login-container">
      <v-list-item-content>
        ...
        <v-list-item-title
          align="center"
          class="login-headline mb-1 darkmode-ign"
          >VarG</v-list-item-title
        >
        <div class="text-center">
          <v-card outlined class="mx-5">
            <v-list-item three-line>
              <v-list-item-content>
                <v-list-item-title class="headline mb-3 mt-2">
                  DEMO VERSION
                </v-list-item-title>
        ...
        <a align="center" class="font-italic mt-6" color="error"
        ...
        <p
          align="center"
          class="login-bottom-links mt-5 mb-5"
          color="lightgrey"
        >
          <em>
...
export default {
  ...
  methods: {
    ...
    getState() {
      // Returns given values from store
      alert(
        "Authenticated: " +
    ...
    login: function () {
      if (this.$refs.login_form.validate()) {
        if (this.input.email == "Demo" && this.input.password == "123456") {
          ...
          dialogComponent.dialogSuccess(
            "Login erfolgreich - Willkommen bei VarG, " +
              this.$store.state.user.name +
              "!"
          );
        } else {
          dialogComponent.dialogError(
            "Login fehlgeschlagen: Verwende bitte die Demo Zugangsdaten"
          );
        }
      }
    },
